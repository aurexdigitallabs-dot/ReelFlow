...
const R2_BUCKET = 'reel-flow';
const R2_ACCESS_KEY_ID = '9edd1a97c02c15f2e895250b8f3587cd';
const R2_SECRET_ACCESS_KEY = '8cd9c1134b16713ae69bf2c0de6a1545f8b7beb6040f62627ac9cd7377edfff4';
...
export const r2Service = {
  ...
  async uploadFile(file: File, folder: 'creators' | 'stores' | 'content' = 'content'): Promise<string> {
    try {
      ...
      return `https://pub-r2.reelflow.app/${fileName}`;
    } catch (err) {
