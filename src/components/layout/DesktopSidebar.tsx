...
export const DesktopSidebar: React.FC = () => {
  const { activeTab, setActiveTab, openAddContent, content, currentStore, goToLanding } = useApp();
  ...
  return (
    <aside className="hidden md:flex flex-col w-60 bg-slate-950/90 border-r border-slate-800/80 p-4 shrink-0 h-[calc(100vh-60px)] sticky top-[60px] overflow-y-auto">
      ...
      {overdueCount > 0 && (
        <div className="mt-auto p-3 mb-2 rounded-xl bg-amber-500/10 border border-amber-500/20 flex items-center gap-2">
      ...
      {/* Subtle Aurex Digitals Attribution */}
      <div className="mt-auto pt-3 border-t border-slate-800/80 flex items-center justify-between px-1">
